...
use window_by_count_bench::{
    bench_window_by_count, bench_window_by_count_payload, bench_window_by_count_single,
};
...
criterion_group!(
    ...
    bench_tap,
    bench_tap_chained,
    bench_window_by_count,
    bench_window_by_count_payload,
    bench_window_by_count_single,
