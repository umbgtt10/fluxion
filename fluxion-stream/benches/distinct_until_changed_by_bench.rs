        ...
        for &threshold in &thresholds {
            ...
            group.bench_with_input(id, &(size, threshold), |bencher, &(size, threshold)| {
                bencher.iter(|| {
                    ...
                    let distinct =
                        stream.distinct_until_changed_by(move |a, b| (a - b).abs() < threshold);
