...
async fn test_ordered_merge_then_filter() -> anyhow::Result<()> {
    ...
    tx2.try_send(Sequenced::with_timestamp(animal_dog(), 2))?;
    tx1.try_send(Sequenced::with_timestamp(person_bob(), 3))?;
...
async fn test_ordered_merge_then_map() -> anyhow::Result<()> {
    ...
    tx1.try_send(Sequenced::with_timestamp(person_alice(), 1))?;
    tx2.try_send(Sequenced::with_timestamp(animal_dog(), 2))?;
    tx1.try_send(Sequenced::with_timestamp(plant_rose(), 3))?;
...
async fn test_ordered_merge_then_ordered_merge() -> anyhow::Result<()> {
    ...
    tx1.try_send(Sequenced::with_timestamp(person_alice(), 1))?;
    tx3.try_send(Sequenced::with_timestamp(plant_rose(), 2))?;
    tx2.try_send(Sequenced::with_timestamp(animal_dog(), 3))?;
    tx1.try_send(Sequenced::with_timestamp(person_bob(), 4))?;
...
async fn test_filter_then_ordered_merge() -> anyhow::Result<()> {
    ...
    // Act
    tx1.try_send(Sequenced::with_timestamp(person_alice(), 1))?; // filtered out
    tx2.try_send(Sequenced::with_timestamp(animal_dog(), 2))?; // passes
    tx1.try_send(Sequenced::with_timestamp(animal_spider(), 3))?; // passes
    tx2.try_send(Sequenced::with_timestamp(plant_rose(), 4))?; // filtered out
...
async fn test_ordered_merge_with_complex_pipeline() -> anyhow::Result<()> {
    ...
    // Act
    tx1.try_send(Sequenced::with_timestamp(person_alice(), 1))?; // age 25, filtered
    tx2.try_send(Sequenced::with_timestamp(animal_dog(), 2))?; // legs 4, filtered
    tx1.try_send(Sequenced::with_timestamp(person_bob(), 3))?; // age 30, passes
    tx2.try_send(Sequenced::with_timestamp(plant_sunflower(), 4))?; // height 180, passes
...
async fn test_ordered_merge_mixed_testdata_then_filter() -> anyhow::Result<()> {
    ...
    person_tx.try_send(Sequenced::with_timestamp(person_bob(), 3))?;
    animal_tx.try_send(Sequenced::with_timestamp(animal_spider(), 4))?;
...
async fn test_ordered_merge_preserves_ordering_through_map() -> anyhow::Result<()> {
    ...
    tx1.try_send(Sequenced::with_timestamp(person("P3".to_string(), 30), 3))?;
    tx2.try_send(Sequenced::with_timestamp(person("P1".to_string(), 10), 1))?;
    tx1.try_send(Sequenced::with_timestamp(person("P4".to_string(), 40), 4))?;
    tx2.try_send(Sequenced::with_timestamp(person("P2".to_string(), 20), 2))?;
...
async fn test_ordered_merge_three_streams_with_filter() -> anyhow::Result<()> {
    ...
    // Act
    tx1.try_send(Sequenced::with_timestamp(person("P1".to_string(), 1), 1))?;
    tx2.try_send(Sequenced::with_timestamp(person("P2".to_string(), 3), 2))?; // divisible by 3
    tx3.try_send(Sequenced::with_timestamp(person("P3".to_string(), 5), 3))?;
    tx1.try_send(Sequenced::with_timestamp(animal("A1".to_string(), 6), 4))?; // divisible by 3
    tx2.try_send(Sequenced::with_timestamp(person("P4".to_string(), 7), 5))?;
    tx3.try_send(Sequenced::with_timestamp(person("P5".to_string(), 9), 6))?; // divisible by 3
...
async fn test_ordered_merge_empty_after_filter() -> anyhow::Result<()> {
    ...
    tx1.try_send(Sequenced::with_timestamp(person("P1".to_string(), 1), 1))?;
    tx2.try_send(Sequenced::with_timestamp(person("P2".to_string(), 2), 2))?;
    tx1.try_send(Sequenced::with_timestamp(person("P3".to_string(), 3), 3))?;
...
async fn test_ordered_merge_map_preserves_timestamps() -> anyhow::Result<()> {
    ...
    // Act
    tx1.try_send(Sequenced::with_timestamp(person("P1".to_string(), 10), 5))?;
    tx2.try_send(Sequenced::with_timestamp(person("P2".to_string(), 20), 10))?;
...
async fn test_ordered_merge_filter_map_chain() -> anyhow::Result<()> {
    ...
    // Act
    tx1.try_send(Sequenced::with_timestamp(person("P1".to_string(), 1), 1))?; // odd, filtered
    tx2.try_send(Sequenced::with_timestamp(person("P2".to_string(), 2), 2))?; // even -> 1
    tx1.try_send(Sequenced::with_timestamp(animal("A1".to_string(), 4), 3))?; // even -> 2
    tx2.try_send(Sequenced::with_timestamp(person("P3".to_string(), 5), 4))?; // odd, filtered
    tx1.try_send(Sequenced::with_timestamp(person("P4".to_string(), 6), 5))?; // even -> 3
