...
//! Fluxion stream operators for single-threaded runtimes
//!
//! This crate provides stream operator traits optimized for single-threaded runtimes
//! (Embassy, WASM). Relaxed bounds allow these to work in environments without Send.

#![cfg_attr(
    not(any(feature = "runtime-embassy", feature = "runtime-wasm")),
    no_std
)]
